...
print(f"Nome original: ({name_person})") # O \t insere uma tabulação 
# (que parece vários espaços antes do nome).O \n pula pra outra linha, e o
# espaço final aparece depois na linha de baixo
...
# lstrip() remove espaços em branco à esquerda (início da string)
# rstrip() remove espaços em branco à direita (final da string)
